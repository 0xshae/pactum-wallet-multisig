...
impl_runtime_apis! {
	...
	impl frame::deps::frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			use frame::deps::frame_benchmarking::{baseline, BenchmarkList};
		...
		fn dispatch_benchmark(
			...
			use frame::deps::frame_benchmarking::{baseline, BenchmarkBatch};
...
pub mod genesis_config_presets {
	...
	pub fn development_config_genesis() -> Value {
		...
		let config = RuntimeGenesisConfig {
			...
			assets: AssetsConfig {
				assets: vec![
					(0, AccountKeyring::Alice.to_account_id(), true, 100_000_000_000_000_000u128),
					(1, AccountKeyring::Bob.to_account_id(), false, 100_000_000_000_000_000u128),
				],
				metadata: vec![],
				accounts: vec![],
